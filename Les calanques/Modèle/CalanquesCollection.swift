...
// C'est la fonction pour tout ajouter

class CalanqueCollection {
    
    func ajouter() -> [Calanque]{
        var calanque: [Calanque] = []

        calanque.append(Calanque(
            nom: "Callelongue",
            ...
            latitude: 43.211772, longitude: 5.352432, image: UIImage(named: "callelongue.jpg"))
        )
        calanque.append(Calanque(
            nom: "La Mounine",
            ...
            latitude: 43.210749, longitude: 5.362573, image: UIImage(named: "mounine.jpg"))
        )
        calanque.append(Calanque(
            nom: "MarseilleVeyre",
            ...
            latitude: 43.209764, longitude: 5.372433, image: UIImage(named: "Marseilleveyre.jpg"))
        )
        calanque.append(Calanque(
            nom: "Sormiou",
        ...
        calanque.append(Calanque(
            ...
            latitude: 43.212627, longitude: 5.454051, image: UIImage(named: "sugiton.jpg"))
        )
        calanque.append(Calanque(
            nom: "Oeil de Verre",
            desc: "Calanque située entre deux falaises de 400 mètres de dénivelé.",
            latitude: 43.208078, longitude: 5.470472, image: UIImage(named: "oeil.jpg"))
        )
        calanque.append(Calanque(
            nom: "Devenson",
            ...
            latitude: 43.206244, longitude: 5.483150, image: UIImage(named: "devenson.jpg"))
        )
        calanque.append(Calanque(
            nom: "En Vau",
            desc: "Calanque entourée de hautes falaises. Elle est un lieu d'escalade unique.\n Elle dispose d'une plage de galets.",
            latitude: 43.202629, longitude: 5.498017, image: UIImage(named: "en vau.jpg"))
        )
        calanque.append(Calanque(
            nom: "Port Pin",
            desc: "Accessible à pied depuis la calanque de Port-Miou.\n Elle dispose d'une petite plage de sable.",
            latitude: 43.204631, longitude: 5.510859, image: UIImage(named: "port pin.jpg"))
        )
        calanque.append(Calanque(
            nom: "Port Miou",
            ...
            latitude: 43.211208, longitude: 5.521256, image: UIImage(named: "port miou.jpg"))
        )
