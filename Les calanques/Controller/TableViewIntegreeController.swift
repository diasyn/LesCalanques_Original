...
class TableViewIntegreeController: UITableViewController {
    var calanques: [Calanque] = [] // on crée l'objet calanque
    var cellID = "CalanqueCell"

    override func viewDidLoad() {
        super.viewDidLoad()
        calanques = CalanqueCollection().ajouter()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: cellID) as? CalanqueCell {
            ...
            return cell // on ne peut pas retourner cette cell tant que l'on n'a pas fait un setup avec une calanque, donc on est sur que çà va exister
        } else {
    ...
    // on va modifier la hauteur des images par une nouvelle méthode
